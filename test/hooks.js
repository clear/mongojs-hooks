...
describe("hooks", function () {
	...
	describe("save()", function () {
		describe("when single collection", function () {
			...
			it("with object should save that object to the database", function (done) {
			...
			it("on defined collection should save that object to the database", function (done) {
				mongo.collection("tests");
			...
			it("with pre() hook on defined collection should call pre() hook before save()", function (done) {
				var tests = mongo.collection("tests");
			...
			it("with post() hook on defined collection should call post() hook after save()", function (done) {
				var tests = mongo.collection("tests");
			...
			it("with pre() hook on defined collection and accessed via tenant should call pre() hook before save()", function (done) {
				var tests = mongo.collection("tests");
				var preStub = sinon.stub();
		...
		describe("when multiple collections", function () {
			var saveStub;
			...
			it("with single defined collection and pre() hook called twice should call hook on collection twice", function (done) {
				var tests = mongo.collection("tests");
				var preStub = sinon.stub();
			...
			it("with two defined collections and pre() hook one one should only call hook on the collection defined", function (done) {
